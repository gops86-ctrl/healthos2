...
import com.healthos.app.feature.data.DataScreenWithMyFitnessPal
...
fun HealthOSNavHost(
    ...
    onHevySync: suspend (String, (Int, String) -> Unit) -> com.healthos.app.data.source.hevy.HevySyncImporter.Result,
    onMyFitnessPalSync: suspend (String, (Int, String) -> Unit) -> MyFitnessPalSyncImporter.Result,
    onDeleteNutritionDay: suspend (Long) -> Unit
) {
    ...
    Scaffold(bottomBar = {
        ...
        NavHost(nav, "overview", modifier = Modifier.padding(padding)) {
            ...
            composable("data") { val vm = viewModel<com.healthos.app.feature.data.DataViewModel>(factory = factory); DataScreenWithMyFitnessPal(vm, onGarminSync, onHevySync, onMyFitnessPalSync) }
